...
void query_ticket(const mystring<20> &loc1, const mystring<20> &loc2, const mystring<10> &date,
	const mystring<10> &catalog, bplus_tree<char> &findtrain, bplus_tree<train> &thetrains, bplus_tree<restTicket> &theRestTicket)
{
	...
	for (int i = 0; i < true_sequence.size(); ++i) {
		...
		if (thetrains.search(train_id, &pos) == 0)
			pos.queryTicket(loc1, loc2, date, theRestTicket);
	}

}

void query_transfer(const mystring<20> &loc1, const mystring<20> &loc2, const mystring<10> & date, const mystring<10> &catalog,
	bplus_tree<char> &findtrain, bplus_tree<train> &thetrains, bplus_tree<char> &location, bplus_tree<restTicket> &theRestTicket)
{
	...
	last_train_one.queryTicket(loc1, last_loc_mid, date, theRestTicket);
	last_train_two.queryTicket(last_loc_mid, loc2, date, theRestTicket);
